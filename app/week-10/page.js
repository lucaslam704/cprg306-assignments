  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold mb-6 text-center">Shopping List Week 10</h1>
        <title>Week 10</title>
        {user ? (
          // User is logged in
          ...
          <div className="flex flex-col items-center">
            ...
            <button 
              ...
              className="bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded flex items-center gap-2 w-full justify-center"
            >
